...
print(MSE1,R21,'rondom')
print(MSE2,R22,'rondom')
...
result1svr=model.predict(X_test1)
MSE1=mean_squared_error(y_test1, result1svr)
R21=r2_score(y_test1,result1svr)
result2svr=model.predict(X_test2)
MSE2=mean_squared_error(y_test2, result2svr)
R22=r2_score(y_test2,result2svr)
print(MSE1,R21,'svm')
print(MSE2,R22,'svm')
...
values =  np.concatenate([y_test1, result1svr], 0)
ptp = np.ptp(values)
min_value = np.min(values) - ptp * 0.1
max_value = np.max(values) + ptp * 0.1
...
plt.scatter(y_test1,result1svr,s=30)
...
values =  np.concatenate([y_test2, result2svr], 0)
ptp = np.ptp(values)
min_value = np.min(values) - ptp * 0.1
max_value = np.max(values) + ptp * 0.1
...
plt.scatter(y_test2,result2svr,s=30)
