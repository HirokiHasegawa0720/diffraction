...
l=['p0[bar]', 'H0[KJ/kg]', 'M0[kg/kmol]', 'γ0[-]', 'a0[m/s]', \
        ...
        'Pvn[bar]', 'Tvn[K]', 'Hvn[KJ/kg]', \
                      'γvn[-]','avn[m/s]',\
                    'inductionlength[m]', 'reactionlength[m]', 'Ea[KJ/kg]']
...
l1=['Fuel','Diluent','Equivalentratio','Diluentratio','p0[bar]', 'H0[KJ/kg]', 'M0[kg/kmol]', 'γ0[-]', 'a0[m/s]', \
        'pcj[bar]', 'Tcj[K]', 'Hcj[KJ/kg]',\
                    'Mcj[kg/kmol]', 'γcj[-]', 'acj[m/s]',\
                         'Mcj[-]', 'Vcj[m/s]',\
        'Pvn[bar]', 'Tvn[K]', 'Hvn[KJ/kg]', \
...
X_valH2 = dfH2train.drop('LR', axis=1)
y_valH2 =  dfH2train['LR']
X_valC2H4AR = dfC2H4ARtrain.drop('LR', axis=1)
y_valC2H4AR =  dfC2H4ARtrain['LR']
...
sX_trainH2 = pd.DataFrame(sX_trainH2,columns=Xpca.columns)
...
sXC2H4ARtest = pd.DataFrame(sXC2H4ARtest,columns=Xpca.columns)
